...
const WA_NUMBER = '263782154206';
const WA_URL = `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Hello! I need help with my MeatLink Zimbabwe order.')}`;
            ...
            <div className={styles.container}>
                <div className={styles.grid}>
                    ...
                    <div className={styles.column}>
                        <h4>Quick Links</h4>
                        <Link href="/shop">Shop Premium Cuts</Link>
                    ...
                    <div className={styles.column}>
                        <h4>Support</h4>
                        <a href={WA_URL} target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
                        <Link href="#">FAQ</Link>
